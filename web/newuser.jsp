...
<% 
   ...
   try
   {
      ...
      String query = "INSERT INTO test_user (index_user, name, username, password, image, date, email, phone) VALUES (?, ?, ?, ?,'', NOW(), ?, ?)";
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">							
												...
												<input name="phone" type="tel" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">							
												...
												<input name="email" type="email" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
										...
										<div class="col-md-8">
											<div class="input-group">							
												...
												<input name="username" type="text" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
																		<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">							
												...
												<input name="password" type="password" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
																		<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">							
												...
												<input name="mypassword" type="password" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
