									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">							
												...
												<input name="husband_name" type="text" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Wife Name</label>
										<div class="col-md-8">
											<div class="input-group">							
												<span class="input-group-addon">
													<i class="fa fa-file-text"></i>
												</span>
												<input name="wife_name" type="text" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
                                                                        <div class="form-group">
										<label class="col-md-2 control-label">Husband Profession</label>
										<div class="col-md-8">
											<div class="input-group">							
												<span class="input-group-addon">
													<i class="fa fa-file-text"></i>
												</span>
												<input name="husband_profession" type="text" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Wife Profession</label>
										<div class="col-md-8">
											<div class="input-group">							
												<span class="input-group-addon">
													<i class="fa fa-file-text"></i>
												</span>
												<input name="wife_profession" type="text" class="form-control1" placeholder="">
											</div>
										</div>
									</div>
